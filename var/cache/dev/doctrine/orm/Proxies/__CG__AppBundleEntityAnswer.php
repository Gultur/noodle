 ...
 */
class Answer extends \AppBundle\Entity\Answer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Answer' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Answer' . "\0" . 'value', '' . "\0" . 'AppBundle\\Entity\\Answer' . "\0" . 'correct', '' . "\0" . 'AppBundle\\Entity\\Answer' . "\0" . 'question'];
        }
