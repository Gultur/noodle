 ...
 */
class AnswerUser extends \AppBundle\Entity\AnswerUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AnswerUser' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\AnswerUser' . "\0" . 'value', '' . "\0" . 'AppBundle\\Entity\\AnswerUser' . "\0" . 'question', '' . "\0" . 'AppBundle\\Entity\\AnswerUser' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\AnswerUser' . "\0" . 'session'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AnswerUser $proxy) {
