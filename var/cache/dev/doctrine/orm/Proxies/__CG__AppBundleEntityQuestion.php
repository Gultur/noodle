...
class Question extends \AppBundle\Entity\Question implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Question' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Question' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Question' . "\0" . 'type', '' . "\0" . 'AppBundle\\Entity\\Question' . "\0" . 'question', '' . "\0" . 'AppBundle\\Entity\\Question' . "\0" . 'time', '' . "\0" . 'AppBundle\\Entity\\Question' . "\0" . 'answers'];
        }
