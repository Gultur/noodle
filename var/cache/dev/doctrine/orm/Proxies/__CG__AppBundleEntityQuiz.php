 ...
 */
class Quiz extends \AppBundle\Entity\Quiz implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Quiz' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Quiz' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Quiz' . "\0" . 'questions', '' . "\0" . 'AppBundle\\Entity\\Quiz' . "\0" . 'sessions'];
        }
