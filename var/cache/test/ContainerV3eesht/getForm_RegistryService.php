...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\AnswerType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\AnswerType']) ? $this->services['AppBundle\Form\AnswerType'] : $this->services['AppBundle\Form\AnswerType'] = new \AppBundle\Form\AnswerType()) && false ?: '_'};
}, 'AppBundle\\Form\\QuestionType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\QuestionType']) ? $this->services['AppBundle\Form\QuestionType'] : $this->services['AppBundle\Form\QuestionType'] = new \AppBundle\Form\QuestionType()) && false ?: '_'};
}, 'AppBundle\\Form\\QuizType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\QuizType']) ? $this->services['AppBundle\Form\QuizType'] : $this->services['AppBundle\Form\QuizType'] = new \AppBundle\Form\QuizType()) && false ?: '_'};
...
}, 'AppBundle\\Form\\UserUpdateType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\UserUpdateType']) ? $this->services['AppBundle\Form\UserUpdateType'] : $this->services['AppBundle\Form\UserUpdateType'] = new \AppBundle\Form\UserUpdateType()) && false ?: '_'};
