...
// Returns the public 'AppBundle\Controller\QuestionController' shared autowired service.
...
include_once $this->targetDirs[3].'/src/AppBundle/Controller/QuestionController.php';

return $this->services['AppBundle\Controller\QuestionController'] = new \AppBundle\Controller\QuestionController();
